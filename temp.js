...
window.addEventListener("load", () => {
    Swal.fire({
      title: "Wow someone has a surprise for you, play music?",
      icon: "warning",
  ...
  const animationTimeline = () => {
    ...
    tl.to(".container", { duration: 0.6, visibility: "visible" })
      ...
      .from(".two", { duration: 0.4, opacity: 0, y: 10 }, "+=1")
      ...
      .to(".idea-2", { duration: 0.7, ...ideaTextTransLeave }, "+=3.5")
      .to(".idea-3", { duration: 0.7, ...ideaTextTransLeave }, "-=1")
  
      .from(".idea-99", { duration: 0.7, ...ideaTextTrans })
      .to(".idea-99", { duration: 0.7, ...ideaTextTransLeave }, "+=2.5")
      .from(".idea-98", { duration: 0.7, ...ideaTextTrans })
      .to(".idea-98", { duration: 0.7, ...ideaTextTransLeave }, "+=2.5")
      .from(".idea-2", { duration: 0.7, ...ideaTextTrans })
